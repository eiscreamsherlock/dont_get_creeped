...
/** @type {string} */
const CACHE_VERSION = '1736896857|21517147394';
/** @type {string} */
const CACHE_PREFIX = 'Dont_get_creeped-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Dont_get_creeped.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Dont_get_creeped.html","Dont_get_creeped.js","Dont_get_creeped.offline.html","Dont_get_creeped.icon.png","Dont_get_creeped.apple-touch-icon.png","Dont_get_creeped.worker.js","Dont_get_creeped.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Dont_get_creeped.wasm","Dont_get_creeped.pck"];
